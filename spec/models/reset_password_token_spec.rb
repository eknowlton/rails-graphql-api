...
RSpec.describe ResetPasswordToken, type: :model do
  ...
  describe ".active" do
    it "can find active tokens" do
      token = create(:reset_password_token, created_at: Time.current)
    ...
    it "does not find expired tokens" do
      create(:reset_password_token, created_at: 10.days.ago)
    ...
    it "does not find used tokens" do
      create(:reset_password_token, used: true)
  ...
  describe ".find_active" do
    it "returns a token from body" do
      user = create(:user)
      reset_password_token = create(:reset_password_token, user: user)
    ...
    it "does not return a non-active token" do
      ...
      reset_password_token = create(
        ...
        created_at: ResetPasswordToken.expires,
        user: user
      )
